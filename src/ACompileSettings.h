...
#ifndef COMPILEOPTION_SPECIAL
  #  define COMPILEOPTION_SPECIAL 0
#endif

#define COMPILEOPTION_VERSIONNUM 301
...
// Windows Win32
  ...
  // USB KEY VERSION
  #if COMPILEOPTION_SPECIAL == 1
    #undef COMPILEOPTION_USEHOMEDIRSTORAGE
    #define COMPILEOPTION_USEHOMEDIRSTORAGE 0
    #undef COMPILEOPTION_SAVEFOLDERNAME
    #define COMPILEOPTION_SAVEFOLDERNAME "SavedGames"
  #endif
