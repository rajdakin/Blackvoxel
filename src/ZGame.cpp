...
bool ZGame::Init_TextureManager(ZLog * InitLog)
{
  ...
  if (Ol) {Path.SetToDataFilesPath(); Path.AddToPath("gui/title_1_2.bmp");              Result = TextureManager.LoadBMPTexture(Path.String,0 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(7, ZLog::FAIL, Err); return(false); } }
  else    {Path.SetToDataFilesPath(); Path.AddToPath("gui/title_2_0.bmp");              Result = TextureManager.LoadBMPTexture(Path.String,0 ,true ,false,32);      if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(3, ZLog::FAIL, Err); return(false); } }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/blackvoxel_title_1_3.bmp");   Result = TextureManager.LoadBMPTexture(Path.String,1 ,!Pi  ,false,128); if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(4, ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/panel_2.bmp");                Result = TextureManager.LoadBMPTexture(Path.String,2 ,true ,true,32 );      if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(5, ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/font_1_1.bmp");               Result = TextureManager.LoadBMPTexture(Path.String,3 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(6, ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/title_1_2.bmp");              Result = TextureManager.LoadBMPTexture(Path.String,4 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(7, ZLog::FAIL, Err); return(false); }
  if (Ol) {Path.SetToDataFilesPath(); Path.AddToPath("gui/tile_1_1.bmp");               Result = TextureManager.LoadBMPTexture(Path.String,5 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(8, ZLog::FAIL, Err); return(false); }}
  else    {Path.SetToDataFilesPath(); Path.AddToPath("gui/screen_button_settings.bmp"); Result = TextureManager.LoadBMPTexture(Path.String,5 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(8, ZLog::FAIL, Err); return(false); }}
           Path.SetToDataFilesPath(); Path.AddToPath("gui/tile_2_1.bmp");               Result = TextureManager.LoadBMPTexture(Path.String,6 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(9, ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/gui_tiles_1_3.bmp");          Result = TextureManager.LoadBMPTexture(Path.String,7 ,false,false,64);     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(10,ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/dialog_background_1_2.bmp");  Result = TextureManager.LoadBMPTexture(Path.String,8 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(11,ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/dialog_voxeltype_1_1.bmp");   Result = TextureManager.LoadBMPTexture(Path.String,9 ,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(12,ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/button_1_5.bmp");             Result = TextureManager.LoadBMPTexture(Path.String,10,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(13,ZLog::FAIL, Err); return(false); }
  if (Ol) {Path.SetToDataFilesPath(); Path.AddToPath("gui/tile_2_2.bmp");               Result = TextureManager.LoadBMPTexture(Path.String,11,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(14,ZLog::FAIL, Err); return(false); }}
  else    {Path.SetToDataFilesPath(); Path.AddToPath("gui/slot_inactive.bmp");          Result = TextureManager.LoadBMPTexture(Path.String,11,!Pi,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(14,ZLog::FAIL, Err); return(false); }}
  if (Ol) {Path.SetToDataFilesPath(); Path.AddToPath("gui/tile_3_1.bmp");               Result = TextureManager.LoadBMPTexture(Path.String,12,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(15,ZLog::FAIL, Err); return(false); }}
  else    {Path.SetToDataFilesPath(); Path.AddToPath("gui/slot_active.bmp");            Result = TextureManager.LoadBMPTexture(Path.String,12,!Pi,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(15,ZLog::FAIL, Err); return(false); }}
  if (Hs) {Path.SetToDataFilesPath(); Path.AddToPath("gui/contribute_1_1.bmp");         Result = TextureManager.LoadBMPTexture(Path.String,13,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(16,ZLog::FAIL, Err); return(false); }}
           Path.SetToDataFilesPath(); Path.AddToPath("gui/background_black.bmp");       Result = TextureManager.LoadBMPTexture(Path.String,14,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(17,ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/dialog_modalbox.bmp");        Result = TextureManager.LoadBMPTexture(Path.String,15,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(18,ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/font_symbols.bmp");           Result = TextureManager.LoadBMPTexture(Path.String,16,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(19,ZLog::FAIL, Err); return(false); }
           Path.SetToDataFilesPath(); Path.AddToPath("gui/buttonpushed.bmp");           Result = TextureManager.LoadBMPTexture(Path.String,17,false,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(20,ZLog::FAIL, Err); return(false); }
  if (!Ol){Path.SetToDataFilesPath(); Path.AddToPath("gui/universe_choice_back.bmp");   Result = TextureManager.LoadBMPTexture(Path.String,18,!Pi  ,true,32 );     if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(20,ZLog::FAIL, Err); return(false); }}
  if (!Ol){Path.SetToDataFilesPath(); Path.AddToPath("gui/settings_background.bmp");    Result = TextureManager.LoadBMPTexture(Path.String,19,true ,true,32 );      if(!Result) { Err.Clear() << ErrMsg << Path; InitLog->Log(20,ZLog::FAIL, Err); return(false); }}
